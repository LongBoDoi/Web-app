...
<section class="mainContent"> 
  ...
  <section class="section1">
    ...
    <div class="section1Content">
      <p><span>Email :</span> <input type='text' class='info_for_update' name='email_update' value='<?=$info["email"]?>'></p>
      <p><span>Website :</span> <input type='text' class='info_for_update' name='website_update' value='<?=$info["website"]?>'></p>
      <p><span>Phone :</span> <input type='text' class='info_for_update' name='phone_update' value='<?=$info["phone"]?>'></p>
      <p><span>Address :</span> <input type='text' class='info_for_update' name='address_update' value='<?=$info["address"]?>'></p>
    </div>
  </section>
  ...
  <section class="section1">
    ...
    <div class="section1Content">
        ...
        <p><span>Ngày sinh :</span> <input type='date' class='info_for_update' name='birth_update' value='<?=$info["date_of_birth"]?>'></p>
