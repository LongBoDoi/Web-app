...
<section class="mainContent"> 
  ...
  <form method='get' action='../UpdateProfile/UpdateProfile.php'>
    <input type="hidden" id='hidden' name='username_info'>
    <input type="submit" id='cancel_button' name="submit" value="Sửa thông tin">
  </form>
</section>

<input type='button' id='update_button' value='Đăng xuất' onclick="window.sessionStorage.removeItem('username'); window.location.assign('../Home_page/home_page.html');">
